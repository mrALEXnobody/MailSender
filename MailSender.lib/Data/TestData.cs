...
namespace MailSender.lib.Data
{
    public static class TestData
    {
        ...
        {
            new Server { Id = 1, Name = "Mail", Address = "smtp.mail.ru", UserName = "UserName", Password = "Pass" },
            new Server { Id = 2, Name = "Yandex", Address = "smtp.yandex.ru", UserName = "UserName", Password = "Pass" },
